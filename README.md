## nao_lola (rolling) - 1.3.0-1

The packages in the `nao_lola` repository were released into the `rolling` distro by running `/usr/bin/bloom-release nao_lola -e --rosdistro rolling` on `Sat, 13 Apr 2024 23:54:42 -0000`
...
## nao_lola (rolling) - 1.2.0-1

The packages in the `nao_lola` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling nao_lola` on `Sat, 09 Dec 2023 01:48:07 -0000`
...
## nao_lola (rolling) - 1.1.1-1

The packages in the `nao_lola` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling nao_lola` on `Wed, 23 Aug 2023 01:18:43 -0000`
...
## nao_lola (rolling) - 1.1.0-2

The packages in the `nao_lola` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling nao_lola` on `Thu, 03 Aug 2023 03:01:16 -0000`
...
## nao_lola (rolling) - 1.1.0-1

The packages in the `nao_lola` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --ros-distro rolling nao_lola` on `Thu, 03 Aug 2023 02:22:49 -0000`
...
## nao_lola (rolling) - 1.0.0-1

The packages in the `nao_lola` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling -e nao_lola` on `Wed, 02 Aug 2023 01:04:06 -0000`
